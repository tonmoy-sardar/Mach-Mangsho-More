        ...
        var rotatingSlider = {
            ...
            renderSlider: function(){
                ...
                var $slide = $(el);
                   ...
                   // $slide.css('padding', upperArcHeight +'px '+slideSidePadding+'px '+lowerArcHeight+'px '+slideSidePadding+'px ');  //25.02.2019
